...
const TELEGRAM_LINKS: Record<string, string> = {
  ...
  'cr4-lakers': 'https://t.me/vicentetipstertelegrambot?start=w48640587',
...
export default function BilheteAcaoSlugPage() {
  ...
  // Obtém o link baseado no slug ou usa o padrão
  const TELEGRAM_LINK = slug && TELEGRAM_LINKS[slug] 
    ? TELEGRAM_LINKS[slug] 
