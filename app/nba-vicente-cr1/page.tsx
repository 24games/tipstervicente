...
const TELEGRAM_LINK = 'https://t.me/vicentetipstertelegrambot?start=w48547349';

export default function NBAVicenteCR1Page() {
  return (
    <>
      <style jsx global>{`
      ...
      <div className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="absolute z-10 px-5 w-full" style={{ top: 'calc(45% + 35px)' }}>
          <motion.div
