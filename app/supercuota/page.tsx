  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/supercuota/images/bg-expert.jpg)',
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl w-full mx-auto text-center mt-[300px] md:mt-[450px] space-y-8">
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-200 leading-relaxed px-4 max-w-4xl mx-auto"
          >
            Acceso exclusivo a jugadas de otro nivel. Deja de regalar tu plata y empieza a facturar con la élite.
          </motion.p>

          {/* Botão CTA com efeito Sheen */}
          <motion.div
          ...
          >
            <a
              ...
              className="btn-sheen inline-flex items-center gap-4 bg-[#00FF88] hover:bg-[#00dd77] text-black text-2xl sm:text-3xl md:text-4xl font-black py-5 px-10 md:py-6 md:px-14 rounded-2xl transition-all duration-300 hover:scale-105 shadow-2xl shadow-[#00FF88]/50 uppercase tracking-wide"
            >
              {/* Ícone WhatsApp */}
              <svg
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 bg-gradient-to-br from-black via-purple-950/40 to-black">
        {/* Glows ambientes */}
        <div className="absolute top-20 left-10 w-96 h-96 bg-[#00FF88]/20 rounded-full blur-[120px] pointer-events-none"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-600/20 rounded-full blur-[120px] pointer-events-none"></div>
