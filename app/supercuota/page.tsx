    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl w-full mx-auto text-center mt-[300px] md:mt-[450px] space-y-8">
          ...
          {/* Botão CTA com efeito Sheen - Maior e em uma linha */}
          <motion.div
          ...
          >
            <a
              ...
              className="btn-sheen inline-flex items-center justify-center gap-3 sm:gap-4 bg-[#00FF88] hover:bg-[#00dd77] text-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black py-5 px-8 sm:px-12 md:py-7 md:px-16 rounded-2xl transition-all duration-300 hover:scale-105 shadow-2xl shadow-[#00FF88]/50 uppercase tracking-wide whitespace-nowrap"
            >
              {/* Ícone WhatsApp */}
              <svg
