  ...
  return (
    <>
      ...
      >
        ...
        {/* Sub headline chamando para ter os mesmos resultados */}
        <motion.p
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8, delay: 0.7 }}
          className="text-xl sm:text-2xl md:text-3xl text-gray-200 leading-relaxed px-4 max-w-4xl mx-auto text-center mt-12 mb-8"
        >
          <span className="font-bold">¿Quieres tener los mismos resultados?</span> Únete ahora y empieza a <span className="font-bold">facturar como ellos.</span>
        </motion.p>

        {/* Botão CTA igual ao da dobra 1 */}
        <motion.div
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
